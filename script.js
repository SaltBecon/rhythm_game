const chart_newyear = {
    ...
    notes:[
        ...
        [
            [[2, 0, 3, 0, 5], [1, 0, 9, 0, 11], [0, 1, 8, 1, 10]],
            0,
            [[0, 1, 6, 1, 8]],
            0,
            [[0, 1, 4, 1, 6]],
            0,
            [[2, 0, 9, 0, 11], [1, 0, 6, 0, 8]],
            [[2, 0, 6, 0, 8], [1, 0, 4, 0, 6]]
        ],
        [
            [[2, 0, 4, 0, 6], [1, 0, 2, 0, 4]],
        ...
        [
            [[2, 0, 3, 0, 5], [1, 0, 0, 0, 2], [1, 0, 9, 0, 11]],
            0,
            0,
            [[2, 0, 0, 0, 2], [2, 0, 9, 0, 11]]
        ],
        [
            [[0, 1, 0, 2, 5], [0, 1, 6, 2, 11], [1, 0, 7, 0, 10]],
            0,
            0,
            [[0, 1, 0, 2, 5], [0, 1, 6, 2, 11]],
            0,
            0,
            [[0, 1, 0, 2, 5], [0, 1, 6, 2, 11], [2, 0, 7, 0, 10]],
            0
        ],
        [
            0,
        ...
        [
            [[0, 1, 0, 2, 5], [0, 1, 6, 2, 11], [1, 0, 1, 0, 4]],
            0,
            0,
            [[0, 1, 0, 2, 5], [0, 1, 6, 2, 11]],
            0,
            0,
            [[0, 1, 0, 2, 5], [0, 1, 6, 2, 11], [2, 0, 1, 0, 4]],
            0
        ],
        [
            0,
        ...
        [
            ...
            [[0, 1, 6, 2, 11]],
            0,
            [[0, 0, 0, 1, 2], [0, 0, 3, 1, 5], [0, 0, 6, 1, 8], [0, 0, 9, 1, 11]],
            0,
            0,
            0
        ],
        ...
        [
            [[1, 1, 8, 1, 11]],
            0,
            [[0, 2, 3, 2, 5], [2, 1, 8, 1, 11]],
            [[0, 2, 6, 2, 8]],
            [[0, 2, 1, 2, 4]],
            0,
            [[1, 1, 5, 2, 7], [1, 1, 9, 2, 11]],
            [[2, 1, 5, 2, 7], [2, 1, 9, 2, 11]]
        ],
        [
            0,
            0,
        ...
        [
            [[1, 1, 8, 1, 11]],
            0,
            [[0, 0, 3, 0, 5], [2, 1, 8, 1, 11]],
            [[0, 0, 6, 0, 8]],
            [[0, 0, 1, 0, 4]],
            0,
            [[1, 0, 5, 1, 7], [1, 0, 9, 1, 11]],
            [[2, 0, 5, 1, 7], [2, 0, 9, 1, 11]]
        ],
        [
            0,
            0,
